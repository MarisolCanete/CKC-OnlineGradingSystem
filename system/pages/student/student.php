                            ...
                            <div class="box">
                                ...
                                <form method="post">
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $squery = mysqli_query($con, "SELECT * from tbl_student");
                                            while($row = mysqli_fetch_array($squery))
                                            {
                                                echo '
                                                <tr>
                                                    <td><input type="checkbox" name="chk_delete[]" class="chk_delete" value="'.$row['stud_id'].'" /></td>
                                                    <td>'.$row['lname'].', '.$row['fname'].$row['mname'].'</td>
                                                    <td>'.$row['contact'].'</td>
                                                    <td>'.$row['address'].'</td>
                                                    <td>'.$row['timestamp'].'</td>
                                                    <td><button class="btn btn-primarybtn-sm" data-target="#editModal'.$row['stud_id'].'" data-toggle="modal"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></td>
                                                </tr>
                                                ';
